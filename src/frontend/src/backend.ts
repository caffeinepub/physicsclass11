...
export class Backend implements backendInterface {
    ...
    async createWorkoutPlan(arg0: WorkoutPlan): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async getCallerWorkoutHistory(): Promise<Array<LogEntry>> {
        if (this.processError) {
            try {
                const result = await this.actor.getCallerWorkoutHistory();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getWorkoutHistory(arg0: Principal): Promise<Array<LogEntry>> {
        if (this.processError) {
            try {
    ...
    async logWorkout(arg0: LogEntry): Promise<void> {
        if (this.processError) {
            try {
